...
class DqFeed(models.Model):
    ...
    source_datafile_path = models.CharField(db_column='SOURCE_DATAFILE_PATH', max_length=150, blank=True, null=True) # Field name made lowercase.
    ...
    feed_received_via = models.CharField(db_column='FEED_RECEIVED_VIA', max_length=50, blank=True, null=True) # Field name made lowercase.
    ...
    reviewed_by = models.CharField(db_column='REVIEWED_BY', max_length=75, blank=True, null=True) # Field name made lowercase.
    ...
    load_table_name = models.CharField(db_column='LOAD_TABLE_NAME', max_length=150, blank=True, null=True) # Field name made lowercase.
    ...
    dest_golden_table_name = models.CharField(db_column='DEST_GOLDEN_TABLE_NAME', max_length=150, blank=True, null=True) # Field name made lowercase.
    dest_golden_table_type = models.CharField(db_column='DEST_GOLDEN_TABLE_TYPE', max_length=25, blank=True, null=True) # Field name made lowercase.
    dest_golden_count = models.IntegerField(db_column='DEST_GOLDEN_COUNT', blank=True, null=True) # Field name made lowercase.
    dest_quar_table_name = models.CharField(db_column='DEST_QUAR_TABLE_NAME', max_length=150, blank=True, null=True) # Field name made lowercase.
    dest_quar_table_type = models.CharField(db_column='DEST_QUAR_TABLE_TYPE', max_length=25, blank=True, null=True) # Field name made lowercase.
    dest_quarantine_count = models.IntegerField(db_column='DEST_QUARANTINE_COUNT', blank=True, null=True) # Field name made lowercase.
    dq_processing_date = models.DateTimeField(db_column='DQ_PROCESSING_DATE', blank=True, null=True) # Field name made lowercase.
    dq_processed_by = models.CharField(db_column='DQ_PROCESSED_BY', max_length=50, blank=True, null=True) # Field name made lowercase.
